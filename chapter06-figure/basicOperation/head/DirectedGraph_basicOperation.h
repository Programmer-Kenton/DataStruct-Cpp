/**
 * @Description TODO 带权有向图的基本操作
 * @Version 1.0.0
 * @Date 2024/4/18 17:31
 * @Author Kenton
 */
#ifndef INC_08WANGDAO_DIRECTEDGRAPH_BASICOPERATION_H
#define INC_08WANGDAO_DIRECTEDGRAPH_BASICOPERATION_H

#include <iostream>
#include <vector>


class DirectedGraph_basicOperation {
private:
    // 图的顶点数量
    int numVertices;
    // 邻接矩阵表示图的边
...
public:
    // 构造函数，初始化图的顶点数量和邻接矩阵
    DirectedGraph_basicOperation(int numVertices);
...
#endif //INC_08WANGDAO_DIRECTEDGRAPH_BASICOPERATION_H
